...
const DECK_ID = '1e_eKQ3kvR7318PCQNxNNsJrsshI9mq9Qi-bLz2UO_aA'

/** Google Slides deck embed URL (auto-advancing + looping). */
const SLIDES_EMBED = `https://docs.google.com/presentation/d/${DECK_ID}/embed?start=true&loop=true&delayms=3000`
