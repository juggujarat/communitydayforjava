...
export default function Gallery() {
  return (
    <>
      <section id="moments-head" style={{ position: 'relative', background: '#0E1667', padding: '110px 40px 48px', textAlign: 'center' }}>
        <div data-reveal>
      ...
      <section id="gallery" style={{ position: 'relative', background: '#0E1667', padding: '0 40px 110px' }}>
        <div style={{ maxWidth: '1140px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gridAutoRows: '190px', gridAutoFlow: 'dense', gap: '14px' }}>
          {SHOTS.map((s, i) => (
            <div
              ...
              style={{ position: 'relative', overflow: 'hidden', borderRadius: '16px', border: '1px solid rgba(255,255,255,.08)', cursor: 'zoom-in', ...(s.big ? { gridColumn: 'span 2', gridRow: 'span 2' } : {}) }}
            >
