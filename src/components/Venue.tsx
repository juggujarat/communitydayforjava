    ...
    <section id="venue" style={{ position: 'relative', padding: '120px 40px', background: '#F4F1E8', color: '#0E1667', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'relative', zIndex: 3, maxWidth: '1140px', margin: '0 auto' }}>
        <div data-reveal style={{ textAlign: 'center', marginBottom: '30px' }}>
          <h2 style={{ margin: 0, fontWeight: 500, fontSize: 'clamp(30px,4.6vw,56px)', lineHeight: 1.04, letterSpacing: '-1.5px' }}>Venue Announced Soon, <span style={{ fontFamily: "'Roboto',sans-serif", fontWeight: 600, color: '#0D5CDB' }}>Ahmedabad</span></h2>
        ...
        <div data-reveal data-reveal-d="80" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(330px,1fr))', gap: '22px', alignItems: 'stretch' }}>
          {/* <div style={{ position: 'relative', borderRadius: '26px', overflow: 'hidden', minHeight: '440px', boxShadow: '0 30px 64px rgba(14,22,103,.22)' }}>
            <img src={A['1480f039-39b0-404c-af90-c8cd572febec']} alt="Ahmedabad" style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
            ...
            <div style={{ position: 'absolute', left: '26px', right: '26px', bottom: '24px', color: '#fff' }}>
              <div style={{ fontWeight: 800, fontSize: '24px', letterSpacing: '-.5px' }}>Venue Announced Soon</div>
              <div style={{ fontSize: '13.5px', opacity: 0.9, marginTop: '4px' }}>Ahmedabad, India</div>
            </div>
          </div> */}
          <div style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
            ...
            <div style={{ background: '#fff', borderRadius: '24px', padding: '24px 26px', boxShadow: '0 12px 30px rgba(14,22,103,.1)' }}>
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: '14px' }}>
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ fontWeight: 800, fontSize: '17px' }}>Venue</div>
                  <div style={{ fontSize: '13.5px', color: '#42498a', marginTop: '3px' }}>Ahmedabad, India</div>
                </div>
              </div>
