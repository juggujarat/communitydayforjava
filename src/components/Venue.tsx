export default function Venue() {
  return (
    <section id="venue" style={{ position: 'relative', padding: '74px 40px', background: '#0E1667', color: '#fff', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'relative', zIndex: 3, maxWidth: '1140px', margin: '0 auto' }}>
        ...
        <div data-reveal data-reveal-d="80" style={{ maxWidth: '900px', margin: '0 auto' }}>
          <div style={{ position: 'relative', height: '420px', borderRadius: '26px', overflow: 'hidden', boxShadow: '0 20px 60px rgba(0,0,0,.35)', border: '1.5px solid rgba(168,176,224,.25)' }}>
            <iframe title="Centre for Professional Courses, Gujarat University map" src="https://www.google.com/maps?q=23.038873494473062,72.54532835582141&output=embed" style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', border: 0, display: 'block' }} loading="lazy" referrerPolicy="no-referrer-when-downgrade" allowFullScreen />
          </div>
        </div>
      </div>
    </section>
